...
@Designate(ocd = SolarSensorConfig.class)
public class SolarSensor implements Sensor {
    ...
    private double minSolarRadiation = 50;
    private double maxSolarRadiation = 1000;
    ...
    @Activate
    private void activate(SolarSensorConfig config) {
    ...
    @Modified
    private void modified(SolarSensorConfig config) {
        if (config != null) {
